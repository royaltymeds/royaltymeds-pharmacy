  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <header className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex justify-between items-center">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <Link
              href="/portal-redirect?from=header"
      ...
      <section className="flex-1 w-full flex flex-col justify-center">
        <div className="w-full bg-green-600 px-4 py-2 sm:px-6 lg:px-8">
          <p className="text-center text-xs sm:text-sm font-medium text-white">
            We&apos;re proud to support professionals, students, and teams across Jamaica with exclusive savings on your pharmacy orders.
          </p>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start lg:items-center">
            ...
            <div className="flex-1 w-full">
              ...
              <p className="text-xs sm:text-sm text-gray-600 mt-6 sm:mt-8 italic">
                Don&apos;t see your company? Contact our support team to explore partnership opportunities.
              </p>
            </div>
          </div>
        </div>
