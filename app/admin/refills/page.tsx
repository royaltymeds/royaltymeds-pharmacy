  ...
  return (
    <div className="space-y-3 sm:space-y-4 md:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-3 md:gap-4">
        <div>
          <h1 className="text-lg sm:text-2xl md:text-3xl font-bold text-gray-900">Refill Management</h1>
          <p className="text-xs sm:text-sm md:text-base text-gray-600 mt-1">Approve or reject medication refill requests</p>
        </div>
        <Link
