    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Recent Pending Prescriptions</h2>
          {pendingPrescriptions && pendingPrescriptions.length > 0 ? (
              ...
              {(pendingPrescriptions as any[]).map((prescription) => (
                ...
                >
                  <div className="flex justify-between items-start">
                    <div>
                      <p className="font-medium text-gray-900">Rx ID: {prescription.id.slice(0, 8)}</p>
            ...
            <p className="text-gray-600 text-sm">No pending prescriptions</p>
          )}
          <Link
            href="/admin/prescriptions"
            className="text-green-600 text-sm font-medium mt-4 hover:text-green-700 inline-block"
