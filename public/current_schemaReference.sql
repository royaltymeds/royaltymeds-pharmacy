...
CREATE TABLE public.doctor_prescriptions (
  ...
  prescription_number text UNIQUE NOT NULL DEFAULT '',
...
CREATE TABLE public.prescriptions (
  ...
  doctor_id uuid,
  prescription_number text UNIQUE NOT NULL DEFAULT '',
  status text NOT NULL DEFAULT 'pending'::text CHECK (status = ANY (ARRAY['pending'::text, 'approved'::text, 'rejected'::text, 'filled'::text])),
