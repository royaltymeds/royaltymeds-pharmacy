...
export interface Order {
  ...
  collect_shipping_after_payment?: boolean; // Whether to collect custom shipping after initial payment verified
  ...
  billing_street_line_1?: string;
  billing_street_line_2?: string;
  billing_city?: string;
